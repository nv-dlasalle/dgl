...
class FastSparseAdam(Optimizer):
    ...
    def __init__(self, params, lr=1e-3, betas=(0.9, 0.999), eps=1e-8):
        ...
        super(FastSparseAdam, self).__init__(params, defaults)
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            for p in group['params']:
                ...
                nvtx.range_push("sparse_optimizer.coalesce()")
                ...
                nvtx.range_push("sparse_optimizer.moment")
                ...
                nvtx.range_push("numer_calc")
                numer = exp_avg_update_values.add_(old_exp_avg_values)
                nvtx.range_pop()
                nvtx.range_push("exp_avg_sq_update")
                exp_avg_sq_update_values.add_(old_exp_avg_sq_values)
                nvtx.range_pop()
                nvtx.range_push("denom_calc")
                denom = exp_avg_sq_update_values.sqrt_().add_(group['eps'])
                nvtx.range_pop()
                del exp_avg_update_values, exp_avg_sq_update_values
                nvtx.range_pop()

                nvtx.range_push("optimizer.correction")
